...
if (isset($_GET['id'])) {
 ...
 $sql = "SELECT * FROM tbl_product WHERE id = '$userid' ";
          ...
          <div class="row">
            ...
            <div class="col-md-5 col-md-offset-1">
              <div class="title mt-0">
                <h2><?php echo $row['pname']; ?><span class="red-dot"></span></h2>
                <p class="m-0">Free Shipping Worldwide</p>
              </div>
              <div class="single-product-price">
                <div class="row">
                  <div class="col-xs-6">
                    <h3><del>$<?php echo $row['rprice']; ?></del><span>$<?php echo $row['sprice']; ?></span></h3>
                  </div>
              ...
              <div class="single-product-list">
                <ul>
                  ...
                  <li><span>Category:</span><a href="#"><?php echo $row['category']; ?></a>
                  </li>
                  <li><span>Tags:</span><a href="#"><?php echo $row['tag']; ?></a>-<a href="#">Jeans</a>
                  </li>
                </ul>
              </div>
            </div>
