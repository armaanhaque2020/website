...
<span>Regular Price</span> 
              <div class="custom"  >
                   ...
                   <input style="width: 30%;" type="text" name="min" placeholder="min">
                   <input style="width: 30%;" type="text" name="max" placeholder="max">
...
$max = '';
 ...
 $sql = "SELECT * FROM tbl_product WHERE sprice BETWEEN '$min' AND '$max' OR pname LIKE '%$max%'";
            ...
            <div class="shop-product">
              <div class="product-thumb">
                <a href="singleproduct.php?id=<?php echo $row['id'];?>">
                 <?php echo '<img src="backend/img/'.$row['pimg'].'">'; ?> 
                </a>
                <div class="product-overlay"><a href="" class="btn btn-color-out btn-sm">Add To Cart<i class="ti-bag"></i></a>
                </div>
              </div>
              <div class="product-info">
                <h4 class="upper"><a href="singleproduct.php?id=<?php echo $row['id'];?>"><?php echo $row['pname']; ?></a></h4><span><?php echo $row['rprice']; ?>$</span>
